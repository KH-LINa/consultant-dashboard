...
import type { ProjectPhase, ProjectTask, ProjectTaskStatus } from '@/lib/types'
import { phaseStatus } from '@/lib/gantt-deps'
...
export function PhasesManager({ projectId, phases, tasks }: { projectId: string; phases: ProjectPhase[]; tasks: ProjectTask[] }) {
